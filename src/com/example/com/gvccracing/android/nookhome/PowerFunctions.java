...
public class PowerFunctions {
	...
	public static boolean actionLock(Activity act) {
		...
		if (isrooted.exists()) {
			...
			Toast.makeText(
					act,
					act.getResources()
							.getString(R.string.power_functions_root_only),
	...
	public static void actionReboot(Activity act) {
		...
		if (isrooted.exists()) {
			...
			builder.setTitle(act.getResources().getString(
					R.string.power_functions_reboot_confirm_title));
			// "Are you sure to reboot your device ? "
			builder.setMessage(act.getResources().getString(
					R.string.power_functions_reboot_confirm_text));
			// "YES"
			final Activity fact = act;
			builder.setPositiveButton(
					act.getResources().getString(R.string.power_functions_yes),
			...
			builder.setNegativeButton(
					act.getResources().getString(R.string.power_functions_no),
					new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog,
								int whichButton) {
						}
	...
	public static void actionPowerOff(Activity act) {
		...
		if (isrooted.exists()) {
			...
			// "Reboot confirmation"
			builder.setTitle(act.getResources().getString(
					R.string.power_functions_poweroff_confirm_title));
			// "Are you sure to reboot your device ? "
			builder.setMessage(act.getResources().getString(
					R.string.power_functions_poweroff_confirm_text));
			// "YES"
			final Activity fact = act;
			builder.setPositiveButton(
					act.getResources().getString(R.string.power_functions_yes),
